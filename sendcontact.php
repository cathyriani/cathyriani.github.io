...
define( "RECIPIENT_NAME", "Cathy Riani" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "cathyriani@gmail.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "hey! hi! hello!" ); //UPDATE THIS TO YOUR SUBJECT
